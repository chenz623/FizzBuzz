...
Let's start off our exploration of Java with a classic programming challenge, Fizz Buzz! xxxx
...
class FizzBuzz {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < 100; i++) { // brackets for blocks of cod
            ...
            if (divisibleBy3 && divisibleBy5) { // use && instead of and

                System.out.println("Fizz Buzz");

            } else if (divisibleBy3) { // use else if instead of elif

                System.out.println("Fizz"); // print syntax is a lot more complicated
